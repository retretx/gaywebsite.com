 ...
 */
final class Version20220803184422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, year INT NOT NULL, credential VARCHAR(255) NOT NULL, photo_url VARCHAR(255) NOT NULL, video_url VARCHAR(255) NOT NULL, preview_video_url VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
